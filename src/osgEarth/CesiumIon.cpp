...
CesiumIon3DTilesLayer::openImplementation()
{
    ...
    const std::string server_url = options().server().get().full();
    const bool is_googleapis = server_url.find("https://tile.googleapis.com") != std::string::npos;
    ...
    else
    {
        ...
        accept_header = ionResource._acceptHeader;
    }
