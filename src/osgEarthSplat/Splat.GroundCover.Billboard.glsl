...
#endif
uniform float oe_GroundCover_color_mix = 0.5;
uniform float oe_GroundCover_color_scale = 2.2;
#ifdef OE_USE_PBR
...
void oe_GroundCover_FS(inout vec4 color)
{
    ...
    vec3 ground_mono = vec3(color.r*0.2126 + color.g*0.7152 + color.b*0.0722);
